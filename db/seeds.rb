...
10.times do
    user = User.create(password: Faker::Internet.password, username: Faker::Name.name, first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, email: Faker::Name.name + "@gmail.com")
